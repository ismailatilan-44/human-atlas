...
## Organ komşuları ve katman düzeltmeleri — 22 Eylül

Toraks ve abdomen/pelvis hedeflerinden tek ilişki adımıyla ulaşılan 46 kavramın TR/EN etiketleri eklendi. 23 kayıtta tam kapsamlı Latin terimi doğrulanmadı; alan boş kaldı. 12 kaynak grubunda Latin seçildiğinde nitelikli İngilizce görüntü adı kullanılır; bu nedenle görüntü yedeği sayısı ile gerçek Latin etiketi eksiği ayrı sayılır. [Son denetim](../../data/model-candidates/organ-neighbor-labels/ui-neighbor-audit-after.json): TR 0 / EN 0 / LA 23 eksik. Kalp boşlukları, akciğer içi damarlar, fonksiyonel karaciğer bölümleri ve yalnız birkaç yüzey içeren geniş kaynak grupları açıklamalarda ayrılır. Kaynak geometri kimlikleri değiştirilmez.

26 kas parçası için TR/EN/LA etiketler ve kas katmanı düzeltmesi uygulandı. Bunların 12'si farenks kasıdır: birincil görüntüleme katmanı resmî IS-A kas tipini izler; kaynak PART-OF bölgesel bağlamı korunur. [Sınıf incelemesi](../../data/model-candidates/system-classification-review/REVIEW.md) 2.234 parçayı tarar, fakat seçilmiş dört tip kökü yalnız 606 parçayı kapsar; kalan 1.628 parça doğrulanmış sayılmaz.

Görsel kabulde karaciğerin hepatovenöz segment yüzeylerinin damar katmanına atanmış olduğu görüldü. Dokuz parça, resmî IS-A organ-segment zinciri ve FMA→FJ eşlemesiyle sindirim katmanına alındı. Sekiz kavrama Türkçe/İngilizce etiket eklendi; kaynaktaki II–IX numaralandırması yeniden yorumlanmadı. [Kanıt](../../data/model-candidates/system-classification-review/hepatic-segment-review.json). Bu aşamada labels.json 235 kayıt içerir; sonraki ekler ayrıca kaydedilir.

Yerel arayüzde sol orta yutak daraltıcı kasının tek yüzeyi ve Muscles sınıfı, karaciğerin sağ fonksiyonel bölümünün Digestive sınıfı ve beş yüzeyi görüldü. 390×844 mobil görünümde yalnız prostatı içeren genital kaynak grubunun açıklaması ve LA modunda “source group” nitelemesi korundu. Tarayıcı hata kaydı boştu. Bunlar anatomist onayı veya fiziksel telefon performans testi değildir.

Akciğer aktarımıyla 17 parankim etiketi (TR/EN), 17 bronkopulmoner segment etiketi (TR/EN/LA) ve iki doku seçim grubu eklendi. Aktif toplam 271 kayıt. Segmentteki kaynak Latin terimi parankim kimliğine kopyalanmaz. Parankim→segment→lob→akciğer yolu gerçek arayüzde izlendi; 390×844 boyutta uzun Türkçe/Latince adlar ve iki yüzeyli apikoposterior parankim görüldü. Mobil dil seçicisi iki harfi tam gösterecek şekilde genişletildi. Yeni iki seçim grubuyla toraks/abdomen tek-adımlı komşu denetimi 48 kavrama çıktı: TR0/EN0/LA25 eksik; iki yeni eksik Latin proje seçim grubudur.
